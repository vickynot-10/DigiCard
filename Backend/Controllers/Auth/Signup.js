...
export const SignupDetails = async(req,res)=>{
    ...
    try{
        ...
        finaldata =  new UsersAuthModel({
            username : data.username , mail :data.mail , password : passwordHasing , isVerified : false
        })
        await finaldata.save();
        sendMail("from nodemailer", `<h1>from nodemailer html </h1>`)
        ...
        return res.status(200).json({
            isCreated : true , msg : "An mail has been send pls verify"
        })
